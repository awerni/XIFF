...
|:------|:---------------------------------|
|0766b1 |P53_PATHWAY                       |
|81c5cc |EPITHELIAL_MESENCHYMAL_TRANSITION |
|2ef471 |KRAS_SIGNALING_UP                 |
|eb1e71 |KRAS_SIGNALING_UP                 |
...
```{r}
simulationResult <- readRDS("simulation-result-v2-2021-07-19.rds")
...
makePlot(accuracyTable2, stat = MEAN) + ggtitle("Accuracy - Mean")
makePlot(accuracyTable2, stat = Q05) + ggtitle("Accuracy - Q05")
makePlot(accuracyTable2, stat = IQR) + ggtitle("Accuracy - IQR")
```
## All boxplots
